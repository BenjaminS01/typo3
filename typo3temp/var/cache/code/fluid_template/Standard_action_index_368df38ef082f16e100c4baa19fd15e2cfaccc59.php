...
class Standard_action_index_368df38ef082f16e100c4baa19fd15e2cfaccc59 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array36 = array();
$array37 = array (
);$array36['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('image.properties.width', $array37)]);
$array36['1'] = '>';
$array38 = array (
);$array36['2'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('image.properties.height', $array38)]);
...
$arguments94['treatIdAsReference'] = NULL;
...
$array129 = array();
$array130 = array (
);$array129['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('image.properties.width', $array130)]);
$array129['1'] = '>';
$array131 = array (
);$array129['2'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('image.properties.height', $array131)]);
